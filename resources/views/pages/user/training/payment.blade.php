<x-user-layout title="Checkout" active="checkout">
                        ...
                        <div class="payment-details ">
                            <div class="item-pricing item-mentor">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <button class="mt-2 mb-2 btn bgTheme w-100 text-white border-12 py-3" type="button"
                                        id="pay-button">
                                        Checkout
                                    </button>
    ...
    @push('addonScript')
        <script type="text/javascript" src="https://app.midtrans.com/snap/snap.js"
            data-client-key="Mid-client-5BKbyWVkA2j5NOnM"></script>
                ...
                window.snap.pay('{{ $transaction->snap_token }}', {
                    onSuccess: function(result) {
                        ...
                        window.location.href =
                            "/order-berhasil?order_id={{ $transaction->transaction_code }}"
                    },
                    onPending: function(result) {
                        window.location.href = "{{ route('profil.myorder') }}"
                    },
